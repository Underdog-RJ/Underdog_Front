...
import nuxt_plugin_tinymce_df4cca50 from 'nuxt_plugin_tinymce_df4cca50' // Source: ..\\plugins\\tinymce (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"UnderdogEdu","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"{{escape description }}"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_tinymce_df4cca50 === 'function') {
    await nuxt_plugin_tinymce_df4cca50(app.context, inject)
  }

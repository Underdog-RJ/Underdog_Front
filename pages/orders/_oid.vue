  ...
  <div class="Page Confirm">
    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tr class="good">
          <td class="name First">
            <a target="_blank" :href="'http://www.feifu.top/course/'+order.courseId">
              <img :src="order.courseCover"></a>
            <div class="goodInfo">
              <input type="hidden" class="ids ids_14502" value="14502">
              <a target="_blank" :href="'http://www.feifu.top/course/'+ order.courseId">{{order.courseTitle}}</a>
            </div>
          </td>
          <td class="price">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          ...
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《优乐学学院购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
